...
var schemaCustomizer = require('part:sanity-plugin-seo-tools/schema-customizer?');
...
var schemaCustomizer__default = /*#__PURE__*/_interopDefaultLegacy(schemaCustomizer);
...
var seoSchema = {
  ...
  fields: [{
    ...
    name: 'focus_keyword',
    type: 'string',
    validation: config.focus_keyword_required ? function (Rule) {
      return Rule.required().error('Focus keyword is required');
    } : undefined
  }, {
    ...
    validation: config.focus_synonyms_required ? function (Rule) {
      return Rule.required().error('Enter at least one focus keyword synonym');
    } : undefined
  }, {
    title: 'SEO Title',
    name: 'seo_title',
    type: 'string',
    validation: config.seo_title_required ? function (Rule) {
      return Rule.required().error('SEO title is required');
    } : undefined
  }, {
    title: 'Meta description',
    name: 'meta_description',
    type: 'text',
    validation: config.meta_description_required ? function (Rule) {
      return Rule.required().error('Meta description is required');
    } : undefined
  }]
};
var index = schemaCustomizer__default['default'] ? schemaCustomizer__default['default'](seoSchema) : seoSchema;
